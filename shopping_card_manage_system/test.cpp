...
//测试：敖瑞成
	...
	//测试：陈腾
		//Administer test;
		//test.account_ = master.administer_->next_->account_;
		//for (int i = 0; i < 7; i++) {
		//	test.password_[0] = master.administer_->next_->password_[0];
		//}
		//test.consumer_ = master.consumer_;
		//ShowWindowAdm(test, master.apply_);
